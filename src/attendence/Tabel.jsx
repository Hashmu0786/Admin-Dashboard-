...
// export default function Tabel({ sendDate }) {
            ...
            <tbody className="text-xs  font-medium font-[roboto] 2xl:text-lg 3xl:text-xl">
              {Todaydata?.attendanceRecords?.map((row, index) => (
                <tr key={row._id}>
                  ...
                  {/* <td className="px-4 py-3 xl:px-6 2xl:py-5 2xl:px-8">
                    {editingRowId === row._id ? (
                      <select
                        value={formData.attendanceStatus}
                        onChange={handleAttendanceChange}
                      ...
                      <span>{row.attendanceStatus}</span>
                    )}
                  </td>
                  <td className="px-6 py-3 xl:px-4 2xl:py-5 2xl:px-6">
                    {editingRowId === row._id ? (
                      <select
                        value={formData.approvalStatus}
                        onChange={handleApprovalChange}
